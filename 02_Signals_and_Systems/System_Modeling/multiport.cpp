...
constexpr powerPair addPowerPair(domain d) {
  ...
  case domain::mechanicalTranslation:
    return {/* force */ 0.0, /* velocity */ 0.0, domain::mechanicalTranslation,
            ioDirection::input};
  case domain::mechanicalRotation:
    return {/* torque */ 0.0, /* angular velocity */ 0.0,
            domain::mechanicalRotation, ioDirection::input};
  case domain::hydraulic:
    return {/* pressure */ 0.0, /* flow rate */ 0.0, domain::hydraulic,
            ioDirection::input};
  case domain::electric:
    return {/* voltage */ 0.0, /* current */ 0.0, domain::electric,
            ioDirection::input};
  }
